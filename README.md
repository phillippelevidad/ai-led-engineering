...
| [wf-create-pr](skills/wf-create-pr/SKILL.md)                       | Writes a GitHub pull request title and body in a plain-English-first house format, then opens or updates the PR with `gh`.                             | `npx skills add phillippelevidad/ai-led-engineering --skill wf-create-pr`                 |
